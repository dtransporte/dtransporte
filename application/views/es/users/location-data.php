...
<span class="float-right"><button class="btn btn-primary btn-restore-address" data-toggle="tooltip" data-placement="bottom" title="Restaurar Direcci&oacute;n"><i class="fas fa-sync-alt"></i></button></span>
<br>
<hr>
