...
| 
|--------------------------------------------------------------------------
| Nombre : first-time-assoc-home.php
|--------------------------------------------------------------------------
|
*/
...
<div class="container-fluid" id="container">
	...
	<div id="first-tabs" class="ui-tabs-vertical ui-helper-clearfix">
		<ul>
			...
			<li class="text-center">
				<a href="#assoc-products" data-toggle="tooltip" data-placement="right" title="Seleccionar Servicios"><h1 class="fas fa-align-justify display-4 fa-fw"></h1></a><br>
				<span class="text-center float-left w-100">Servicios</span>
			</li>
			<li class="text-center">
				<a href="#user-settings" data-toggle="tooltip" data-placement="right" title="Opciones"><h1 class="fas fa-users-cog display-3 fa-fw"></h1></a><br>
		...
		<div id="assoc-products">
			<div class="alert alert-light">
				<h2><i class="fas fa-align-justify"></i> Seleccionar Servicios</h2>
				<hr class="bg-dark dtr">
				<form id="frm-assoc-products" method="post">
					<input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" >
					<?php $this->load->view('es/products/assoc')?>
					<br>
					<!-- <button type="submit" class="btn btn-primary btn-block" id="btn-save-products">Agregar Servicios</button> -->
				</form>
			</div>
		</div>
