...
/*
|--------------------------------------------------------------------------
| Vista pagina detalles de requerimientos mercaderia peligrosa solicitudes usuario (Espanol)
|--------------------------------------------------------------------------
|
|--------------------------------------------------------------------------
						...
						<div id="collapse-<?=$key?>" class="collapse <?=$show?>" aria-labelledby="heading-<?=$key?>" data-parent="#accordion-hazard-products">
							<div class="card-body draggable">
								<?php foreach($hprod as $k => $hp):?>
									<?php if($k != 'name'):?>
										<div class="media container-dragged" id="hp-<?=$k?>" data-product="<?=$k?>" data-product-id="<?=$key?>">
